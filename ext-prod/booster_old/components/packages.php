...
return array(
	...
	'x-editable' => array(
		...
		'depends' => array('jquery','booster.js', 'datepicker') /* this is to ensure that datepicker always come before editable */
	),
	'moment' => array(
		'baseUrl' => $this->getAssetsUrl(),
	...
	'picker' => array(
		...
		'js' => array('booster.picker.js'),
		'css' => array('booster.picker.css'),
		'depends' => array('booster.js')
	),
	'booster.wizard' => array(
		'baseUrl' => $this->getAssetsUrl() . '/bootstrap-wizard',
		'js' => array($this->minify ? 'jquery.booster.wizard.min.js' : 'jquery.booster.wizard.js')
	),
	'ajax-cache' => array(
