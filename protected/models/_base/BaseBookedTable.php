...
/**
 * This is the model base class for the table "{{booked_table}}".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "BookedTable".
 *
 * Columns in table "{{booked_table}}" available as properties of the model,
 ...
 *
 */
abstract class BaseBookedTable extends GxActiveRecord
    {
    ...
    public static function label($n = 1)
        {
        return Yii::t('app', 'Booked Table|Booked Tables', $n);
        }
    ...
    public function rules()
        {
        return array(
            array('date, time, party_size, first_name, last_name, email, phone_no, create_time', 'required'),
            ...
            array('id, date, time, party_size, first_name, last_name, email, phone_no, special_request, email_subscription, state_id, type_id, create_time, update_time, create_user_id', 'safe', 'on' => 'search'),
        );
        }
