...
<div class="view">
	...
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('meal_id')); ?>:
		<?php echo GxHtml::encode(GxHtml::valueEx($data->meal)); ?>
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('title')); ?>:
	<?php echo GxHtml::encode($data->title); ?>
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('sub_title')); ?>:
	<?php echo GxHtml::encode($data->sub_title); ?>
	<br />
	...
	<br />
	<?php /*
	<?php echo GxHtml::encode($data->getAttributeLabel('background_image')); ?>:
	<?php echo GxHtml::encode($data->background_image); ?>
	<br />
