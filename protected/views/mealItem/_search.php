...
?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model, 'meal_id', GxHtml::listDataEx(Meal::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model, 'sub_title', array('maxlength' => 256)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model, 'image', array('maxlength' => 256)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'background_image'); ?>
		<?php echo $form->textField($model, 'background_image', array('maxlength' => 256)); ?>
	</div>
