                ...
                <table width='100%' cellpadding='0' cellspacing='0'>
                    <tbody><tr>
                            <td style='padding:19px 0px 10px;text-align:center;vertical-align:top' align='center' valign='top'>
                                <span style='font-family:"HelveticaNeue-Light","Helvetica Neue Light","Helvetica Neue","Helvetica,Arial","Lucida Grande","sans-serif";font-size:28px;font-weight:normal;line-height:30px;text-align:center'> Your Booking has been Canceled </span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style='padding:0px 0px 10px;text-align:center;vertical-align:top' align='center' valign='top'>
                                <span style='font-family:"HelveticaNeue-Light","Helvetica Neue Light","Helvetica Neue","Helvetica,Arial","Lucida Grande","sans-serif";font-size:14px;font-weight:normal;line-height:21px;text-align:center'><span> <?php echo $model->phone_no; ?> </span></span>
                            </td>
                        </tr>    <tr>
                            <td style='padding:0px 0px 10px;text-align:center;vertical-align:top' align='center' valign='top'>
                        ...
                        <tr>
                            <td style='padding:0px 0px 10px;text-align:center;vertical-align:top' align='center' valign='top'>
                                <span style='font-family:"HelveticaNeue-Light","Helvetica Neue Light","Helvetica Neue","Helvetica,Arial","Lucida Grande","sans-serif";font-size:16px;font-weight:normal;line-height:21px;text-align:center'>Table for <?php
                                    echo
                                    $model->party_size;
                                    ?> on Thursday, <?php echo date('dS M Y', strtotime($model->date)); ?> at  <?php echo $model->time; ?> </span>
                            </td>
                        </tr>
