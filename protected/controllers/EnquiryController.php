...
class EnquiryController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'Enquiry');
	...
	public function actionCreate() 
	{
		...
		$this->performAjaxValidation($model, 'enquiry-form');

		if (isset($_POST['Enquiry'])) {
			$model->setAttributes($_POST['Enquiry']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'Enquiry')->delete();
	...
	public function actionSearch()
	{
		...
		{
			$model->setAttributes($_GET['Enquiry']);
	...
	{	
		...
		if ( $model == null ) $model = new Enquiry();
