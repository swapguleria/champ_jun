...
class OpeningTimeController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'OpeningTime');
	...
	{
		$model = new OpeningTime;

		$this->performAjaxValidation($model, 'opening-time-form');

		if (isset($_POST['OpeningTime'])) {
			$model->setAttributes($_POST['OpeningTime']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'OpeningTime')->delete();
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('OpeningTime');
	...
	public function actionSearch()
	{
		...
		if (isset($_GET['OpeningTime']))
		{
			$model->setAttributes($_GET['OpeningTime']);
	...
	{	
		...
		if ( $model == null ) $model = new OpeningTime();
