...
class AuthSessionController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'AuthSession');
	...
	public function actionCreate() 
	{
		...
		$this->performAjaxValidation($model, 'auth-session-form');

		if (isset($_POST['AuthSession'])) {
			$model->setAttributes($_POST['AuthSession']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'AuthSession')->delete();
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('AuthSession');
	...
	public function actionSearch()
	{
		...
		if (isset($_GET['AuthSession']))
		{
			$model->setAttributes($_GET['AuthSession']);
	...
	{	
		...
		if ( $model == null ) $model = new AuthSession();
