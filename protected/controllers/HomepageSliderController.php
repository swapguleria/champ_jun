...
class HomepageSliderController extends GxController
    {
    ...
    public function actionView($id)
        {
        $model = $this->loadModel($id, 'HomepageSlider');
    ...
    public function actionCreate()
        ...
        $this->performAjaxValidation($model, 'homepage-slider-form');

        if (isset($_POST['HomepageSlider']))
            {
//            print_r($_FILES);
//            exit();
            $model->setAttributes($_POST['HomepageSlider']);
    ...
    public function actionDelete($id)
        ...
        if (Yii::app()->getRequest()->getIsPostRequest())
            {
            $this->loadModel($id, 'HomepageSlider')->delete();
    ...
    public function actionSearch()
        ...
        if (isset($_GET['HomepageSlider']))
            {
            $model->setAttributes($_GET['HomepageSlider']);
    ...
    public function actionAdmin()
        ...
        if (isset($_GET['HomepageSlider'])) $model->setAttributes($_GET['HomepageSlider']);
    ...
    protected function updateMenuItems($model = null)
        ...
        if ($model == null) $model = new HomepageSlider();
