...
class MealItemController extends GxController {
	...
	{
		$model = $this->loadModel($id, 'MealItem');
	...
	public function actionCreate() 
	{
		...
		$this->performAjaxValidation($model, 'meal-item-form');

		if (isset($_POST['MealItem'])) {
			$model->setAttributes($_POST['MealItem']);
	...
	public function actionDelete($id) 
	{
		...
		if (Yii::app()->getRequest()->getIsPostRequest()) {
			$this->loadModel($id, 'MealItem')->delete();
	...
	public function actionIndex() 
	{
		...
		$dataProvider = new CActiveDataProvider('MealItem');
	...
	public function actionSearch()
	{
		...
		if (isset($_GET['MealItem']))
		{
			$model->setAttributes($_GET['MealItem']);
	...
	{	
		...
		if ( $model == null ) $model = new MealItem();
