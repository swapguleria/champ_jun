...
class MenuController extends GxController {
	...
	//	Yii::log(CVarDumper::DumpAsString($model),CLogger::LEVEL_WARNING);
		...
		if (isset($_POST['Menu'])) {
			...
			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					...
					$this->redirect(array('page/create', 'id' => $model->id));
			}
		}
		$this->updateMenuItems($model);
