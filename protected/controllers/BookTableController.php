...
//            die();
            ...
            if ($model_enq->save())
                ...
                $model_enq->sendEmail($model_enq->email, 'Booking Enquiry', 'enquiry');
                $model_enq->sendEmail("swap.guleria@gmail.com", 'Booking Enquiry', 'enquiry_admin');
                $success = "success";
                }
            else
                {
        ...
        $this->render('book', array('model' => $model, 'model_enq' => $model_enq, 'success' => $success));
        }
