...
class ContactDetailsController extends GxController
    {
    ...
    public function accessRules()
        ...
        return array(
            array('allow',
                'actions' => array('index', /* 'download', 'thumbnail' */),
                'users' => array('*'),
            ),
            array('allow',
                'actions' => array('create', 'view', 'update', 'search'),
                'users' => array('@'),
            ),
            array('allow',
    ...
    public function actionView($id)
        {
        $model = $this->loadModel($id, 'ContactDetails');
    ...
    public function actionCreate()
        ...
        $this->performAjaxValidation($model, 'contact-details-form');

        if (isset($_POST['ContactDetails']))
            {
            $model->setAttributes($_POST['ContactDetails']);
    ...
    public function actionUpdate($id)
        ...
        if ($model)
            {
            $old_footer_image = $model->footer_image;
            $old_logo = $model->logo;
        ...
        if (isset($_POST['ContactDetails']))
            {
            $model->setAttributes($_POST['ContactDetails']);
            $footer_image = $model->saveUploadedFile($model, 'footer_image');
            $logo = $model->saveUploadedFile($model, 'logo');
            $page_image = $model->saveUploadedFile($model, 'page_image');
            if (!$footer_image)
                {
                $model->footer_image = $old_footer_image;
                }
            if (!$logo)
                {
                $model->logo = $old_logo;
    ...
    public function actionDelete($id)
        ...
        if (Yii::app()->getRequest()->getIsPostRequest())
            {
            $this->loadModel($id, 'ContactDetails')->delete();
    ...
    public function actionIndex()
        ...
        $dataProvider = new CActiveDataProvider('ContactDetails');
    ...
    public function actionSearch()
        ...
        if (isset($_GET['ContactDetails']))
            {
            $model->setAttributes($_GET['ContactDetails']);
    ...
    public function actionAdmin()
        {
        $model = new ContactDetails('search');
        $model->unsetAttributes();
        $this->updateMenuItems($model);

        if (isset($_GET['ContactDetails'])) $model->setAttributes($_GET['ContactDetails']);
    ...
    protected function updateMenuItems($model = null)
        ...
        if ($model == null) $model = new ContactDetails();
